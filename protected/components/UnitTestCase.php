...
class UnitTestCase extends CDbTestCase
{
	...
	/**
	 * Returns the response output that was create by the controller action in the source
     ...
     * @return void
     */
    public function assertXpathExists($path,$msg=false)
    {
        if(!$msg)
    ...
    protected function setUp()
    {
        ...
        $_SERVER=array(
                ...
                'SCRIPT_FILENAME'=>realpath(dirname(__FILE__) . "/../../index.php"), // the other fields should follow
                'SCRIPT_NAME'=>"index.php", // the other fields should follow
                'PHP_SELF'=>'', // the other fields should follow
                'REMOTE_ADDR' => '127.0.0.1',
        		'SERVER_PORT' => 80,
        		'HTTP_HOST' => 'testing.local',
                'REQUEST_URI'=>'participant/something', // the other fields should follow
        );
        global $dontthrowlogger;
    ...
    public function runControllerWithException($param)
    {
    	...
    	{
    		return array('class' => get_class($ex),'message' => $ex->getMessage());
    	}
    ...
    {
    	$setmethods = is_array($methods) ? $methods : array($methods);
    	return $this->getMockBuilder($class)->disableAutoload()->disableOriginalConstructor()->setMethods($setmethods)->getMock();
    }
}
